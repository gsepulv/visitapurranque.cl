        ...
        <div class="ficha-info-grid">
            ...
            <div>
                ...
                <div class="map-wrap">
                    ...
                    <div class="map-interaction-overlay" id="ficha-map-overlay">
                ...
                (function(){
                    ...
                    var wrapper = document.getElementById('ficha-map').parentElement;
                    var overlay = document.getElementById('ficha-map-overlay');
